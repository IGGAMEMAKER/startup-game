...
export const PROGRAMMER_SALARY_MIDDLE = 6;
export const PROGRAMMER_SALARY_SENIOR = 8;

export const PROGRAMMER_CODE_QUALITY_INTERN = 1;
export const PROGRAMMER_CODE_QUALITY_JUNIOR = 3;
export const PROGRAMMER_CODE_QUALITY_MIDDLE = 6;
export const PROGRAMMER_CODE_QUALITY_SENIOR = 8;
