...
export const DURATION_TEMPORARY_BONUS = 100 * modifier;
export const DURATION_CORE_EXPLORE = 33 * modifier;
export const DURATION_CORE_UPGRADE = 100 * modifier;
export const DURATION_OFFER_UPGRADE = 25 * modifier;
export const DURATION_OFFER_EXPLORE = 10 * modifier;

export const DURATION_CHANNEL_EXPLORE = 15 * modifier;
