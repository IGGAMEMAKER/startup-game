...
export const DURATION_CORE_EXPLORE = 33;
export const DURATION_CORE_UPGRADE = 100;
export const DURATION_OFFER_UPGRADE = 25;
export const DURATION_OFFER_EXPLORE = 10;

export const DURATION_CHANNEL_EXPLORE = 15;
